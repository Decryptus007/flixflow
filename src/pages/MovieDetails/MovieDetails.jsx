        ...
        <div className="overflow-hidden pb-40 px-2 md:px-4">
          <div className="relative">
            ...
            <div className="absolute z-[3] bottom-0 left-0 w-full flex justify-center">
              <div className="bg-white/20 rounded-xl px-4 flex flex-col justify-center gap-4 w-11/12 h-24 md:w-[700px]">
                <div className="flex items-center justify-between">
                  <p className='movie-title font-extrabold text-xl md:text-2xl'>{movieData.title}</p>
                  <div className="flex items-center gap-4">
                    {/* Share */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-yellow-500 cursor-pointer w-6 h-6">
